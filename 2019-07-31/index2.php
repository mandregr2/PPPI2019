...
//aritimetica
            ...
            switch ($formaPagamento) {
                case DINHEIRO: print "PAGAMENTO COM DINHEIRO<br />";
                    break;
                case CARTAO: print "PAGAMENTO EM CARTÃO<br />";
                    break;
                default: print "FORMA DE PAGAMENTO NÃO DEFINIDA";
                    break;  //PODE OU NÃO TER BREAK SÓ SE TIVER NO INICIO.
            }
            //VALOR INTEIRO
            $x = 3;
